...
public class AboutActivity extends AppCompatActivity
{
    ...
    {
        Intent fbIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.facebook.com/hunny.narwal"));
    ...
    {
        Intent instaIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.instagram.com/sicl3lement/"));
